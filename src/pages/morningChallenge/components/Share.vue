    ...
    <div :class="showShare?'share show':'share'">
      ...
      <div class="share-panel">
        ...
        <div class="share-bd">
          ...
          <div class="h2">当前打卡收益<span> +{{percent}}%</span></div>
          <div class="line"></div>
...
<script>
import shareTp from "@/assets/images/morningChallenge/share_tp.png";
...
.share {
  ...
  .share-panel {
    ...
    .share-t {
      ...
      width: 100%;
      height: 275px;
      background: url(../../../assets/images/morningChallenge/share_tp.png)
        no-repeat center;
