      ...
      <div class="list" v-if="list&&list.length>0">
        ...
        <div :class="item.show?'item show':'item'"
         ...
         >
          <div class="item-hd">
            <div class="l">
              <span class="issue">{{item.issueDesc}}</span><span class="time">{{item.date}}</span>
            </div>
            <div class="ball">
              <span>{{item.blueNumer}}</span>
            </div>
            <div
              class="r"
          ...
          <div class="item-bd">
            ...
            <div class="detail">
              <div class="detail-wrap">
                <div class="h1">中奖号码：<span>{{item.desc}}</span></div>
                <div class="detail-list">
                  <div
                    class="detail-item"
                    v-for="item2 in item.number"
                    :key="item2"
                  >
                    <div class="ball"><span>{{item2}}</span></div>
                  </div>
                  <!-- 篮球 -->
                  <div
                    class="detail-item"
                    >
                    <div class="active ball"><span>{{item.blueNumer}}</span></div>
                  </div>
                </div>
              </div>

              <div class="h5">本期瓜分奖金 <span>{{item.bonus}}<em>元</em></span></div>
...
export default {
  ...
  methods: {
    ...
    loadData(done) {
      ...
      axios
        .get(`/lottery/issue?token=${this.token}&next=${this.next}`)
        .then(res => {
          // console.log(res)
          ...
          .detail-list {
            ...
            .detail-item {
              ...
              .ball {
                ...
                justify-content: center;
                align-items: center;
                background: url(../../assets/images/lottery/ball_red.png)
